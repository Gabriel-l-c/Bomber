...
image_path = 'C:\Users\Lenovo\Desktop\Bomberman\Bomberman-example\images\enemy\e'
...
class Enemy:
    ...
    def load_animations(self, en, scale):
        ...
        if en == '':
            image_path = 'C:\Users\Lenovo\Desktop\Bomberman\Bomberman-example\images\hero\p'
