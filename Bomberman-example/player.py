...
endereco ='C:\Users\Lenovo\Desktop\Bomberman\Bomberman-example\images'
...
class Player:
    ...
    def load_animations(self, scale):
        ...
        f1 = pygame.image.load(endereco+'\hero\pf0.png')
        f2 = pygame.image.load(endereco+'\hero\pf1.png')
        f3 = pygame.image.load(endereco+'\hero\pf2.png')
        ...
        r1 = pygame.image.load(endereco+'\hero\pr0.png')
        r2 = pygame.image.load(endereco+'\hero\pr1.png')
        r3 = pygame.image.load(endereco+'\hero\pr2.png')
        ...
        b1 = pygame.image.load(endereco+'\hero\pb0.png')
        b2 = pygame.image.load(endereco+'\hero\pb1.png')
        b3 = pygame.image.load(endereco+'\hero\pb2.png')
        ...
        l1 = pygame.image.load(endereco+'\hero\pl0.png')
        l2 = pygame.image.load(endereco+'\hero\pl1.png')
        l3 = pygame.image.load(endereco+'\hero\pl2.png')
